document.addEventListener('DOMContentLoaded', function() {
    console.log("DOM fully loaded, initializing health navigation...");
    ...
    const defaultPage = document.getElementById('all-health');
    if (defaultPage) {
...
function setupBackButton() {
    ...
    backButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            console.log("Back button clicked - returning to All Health");
        });
    });
}
